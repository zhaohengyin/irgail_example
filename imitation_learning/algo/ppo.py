...
from imitation_learning.buffer import RolloutBuffer, Buffer
from imitation_learning.network import StateIndependentPolicy, StateDependentPolicy, StateFunction
...
class PPO(Algorithm):
    ...
    def load_actor(self, path, cpu=False):
        if not cpu:
    ...
    def step(self, env, state, t, step):
        ...
        #self.past_buffer.append(state, action, reward, mask, next_state)
